        ...
        <div className="flex gap-2">
            ...
            <Dialog open={newItemOpen} onOpenChange={setNewItemOpen}>
                ...
                <DialogContent className="max-w-2xl">
                    ...
                    <div className="grid gap-4 py-4">
                        <div className="grid grid-cols-2 gap-4">
                             <div className="grid gap-2"><Label>SKU (Código)</Label><Input value={newItem.sku} onChange={e => setNewItem({...newItem, sku: e.target.value})} /></div>
                             <div className="grid gap-2"><Label>Nome do Item</Label><Input value={newItem.name} onChange={e => setNewItem({...newItem, name: e.target.value})} /></div>
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                    ...
                    <DialogFooter><Button onClick={handleAddItem}>Cadastrar Item</Button></DialogFooter>
                </DialogContent>
            </Dialog>
        </div>
      </div>
